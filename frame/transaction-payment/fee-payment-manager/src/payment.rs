...
pub trait OnChargeAssetTransaction<T: Config> {
	...
	type AssetId: FullCodec + Copy + MaybeSerializeDeserialize + Debug + Default + Eq + TypeInfo + From<VoteAssetId>;
...
where
	...
	AssetIdOf<T>: FullCodec + Copy + MaybeSerializeDeserialize + Debug + Default + Eq + TypeInfo + From<VoteAssetId>,
{
